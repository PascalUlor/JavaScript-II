...
runners.forEach(runner => {
    nameObject = {};
    nameObject.firstName = runner.first_name;
    nameObject.lastName = runner.last_name;
    fullName.push(`${nameObject.firstName} ${nameObject.lastName}`)
    fullName.push(nameObject)
})
...
runners.map(runner => {
    nameObject = {};
    nameObject.firstName = runner.first_name;
    allCaps.push(nameObject.firstName.toUpperCase())
})
console.log(allCaps); 
